(custom-set-variables
 ...
 '(cljr-libspec-whitelist
   '("^cljsns" "^slingshot.test" "^monger.joda-time" "^monger.json" "^gomore-api.factories" "^matcher-combinators.clj-test"))
 '(coffee-tab-width 2)
 ...
 '(package-selected-packages
   '(copilot copilot-chat vertico diff-hl counsel-tramp robe terraform-mode evil-mc undo-tree github-review twilight-bright-theme sqlite3 highlight-indent-guides multi-vterm vterm smartparens evil-multiedit string-inflection company-flx company-fuzzy minions doom-modeline eyebrowse emmet-mode git-link expand-region magit-delta rvm treemacs-evil add-node-modules-path kubernetes typescript vscode-dark-plus-theme monokai-theme dracula-theme rainbow-mode gruvbox-theme tree-sitter tree-sitter-langs clj-refactor which-key company-box company-quickhelp evil-cleverparens zprint-mode npm-mode browse-at-remote egg-timer yaml-mode flymake-eslint restclient typescript-mode rjsx-mode multiple-cursors yasnippet ranger dired-git-info tramp-theme cyberpunk-theme treemacs rainbow-delimiters projectile flycheck prettier-js web-mode ido-vertical-mode flx-ido company-posframe company git-gutter-fringe+ evil-magit evil-matchit evil-collection evil-owl evil-nerd-commenter evil-surround evil ag exec-path-from-shell smex ido-completing-read+ cider clojure-mode-extra-font-locking clojure-mode paredit use-package))
